        ...
        <ScrollView style={{ backgroundColor: '#fff', flex: 1 }}>
            <View style={{ marginTop: 40 }}>
                <View style={{ alignItems: 'center', flexDirection: 'row', justifyContent: 'center' }}>
                    <Image source={require('../assets/logoDangKy.png')} style={{ height: 200, width: 260, marginLeft: 0 }} />
                </View>
                ...
                <View style={{marginTop:20}}>
                    ...
                    >
                        ...
                        <View style={{ marginTop: 25, flexDirection: 'row' }}>
                            <Text style={{ color: 'rgba(136,147,165,255)' }}>Đã có tài khoản ?</Text>
                            <TouchableOpacity
                                onPress={() => {
                                    props.navigation.navigate("DangNhap")
                                }}
                            >
                                <Text style={{ marginLeft: 5, color: 'rgba(28,100,209,255)', fontWeight: '500' }}>Đăng nhập</Text>
                            </TouchableOpacity>
                        </View>
                    </KeyboardAvoidingView>
                </View>

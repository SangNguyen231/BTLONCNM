                ...
                <View>
                    ...
                    >
                        ...
                        <View style={{ top: 20, marginLeft: 200 }}>
                            ...
                            >
                                <Text style={{ color: 'rgba(28,100,209,255)', fontWeight: '500' }}>Quên mật khẩu ?</Text>
                            </TouchableOpacity>
                        </View>
                        ...
                        <View style={{ marginTop: 35, flexDirection: 'row' }}>
                            <Text style={{ color: 'rgba(136,147,165,255)' }}>Chưa có tài khoản ?</Text>
                            <TouchableOpacity
                                onPress={() => {
                                    props.navigation.navigate("DangKy")
                                }}
                            >
                                <Text style={{ marginLeft: 5, color: 'rgba(28,100,209,255)', fontWeight: '500' }}>Đăng ký</Text>
                            </TouchableOpacity>
                        </View>
                    </KeyboardAvoidingView>
                </View>
